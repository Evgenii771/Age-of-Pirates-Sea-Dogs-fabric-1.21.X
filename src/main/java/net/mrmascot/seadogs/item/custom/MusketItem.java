...
//    }
    ...
    public static record LoadingSounds(Optional<RegistryEntry<SoundEvent>> start, Optional<RegistryEntry<SoundEvent>> mid, Optional<RegistryEntry<SoundEvent>> end) {
        public static final Codec<net.minecraft.item.CrossbowItem.LoadingSounds> CODEC = RecordCodecBuilder.create((instance) -> instance.group(SoundEvent.ENTRY_CODEC.optionalFieldOf("start").forGetter(net.minecraft.item.CrossbowItem.LoadingSounds::start), SoundEvent.ENTRY_CODEC.optionalFieldOf("mid").forGetter(net.minecraft.item.CrossbowItem.LoadingSounds::mid), SoundEvent.ENTRY_CODEC.optionalFieldOf("end").forGetter(net.minecraft.item.CrossbowItem.LoadingSounds::end)).apply(instance, net.minecraft.item.CrossbowItem.LoadingSounds::new));
